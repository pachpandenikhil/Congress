...
public class BillsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTabHost.addTab(mTabHost.newTabSpec("active_bills").setIndicator("Active Bills"),
                ActiveBills.class, null);
        mTabHost.addTab(mTabHost.newTabSpec("new_bills").setIndicator("New Bills"),
                NewBills.class, null);
